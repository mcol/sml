...
\title{SML the Structure-Conveying Modelling Language \\
   \bf User's Guide}
...
School of Mathematics\thanks{Email: {\tt sml-support@maths.ed.ac.uk}}, \\ University of Edinburgh, UK
}
...
keywords and structures into the AMPL language.
...
\subsubsection{Acquiring the ModelInterface object}
...
offers two iterators for moving through the tree, and further allows direct
...
The component {\tt std::vector<ModelInterface*> ModelInterface::children} allows
